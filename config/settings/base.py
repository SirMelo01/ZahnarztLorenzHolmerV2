...
RECOVERY_BACKUP_PREFIX = env("RECOVERY_BACKUP_PREFIX", default="private/holmer/recovery-backups")
...
EMAIL_OWNER = env("EMAIL_OWNER", default="info@dr-holmer.de")
DASHBOARD_URL = env("DASHBOARD_URL", default="https://zahnarzt-dr-holmer.de/")
...
ADMINS = [
    (
        env("DJANGO_ADMIN_NAME", default="YooLink"),
        env("DJANGO_ADMIN_EMAIL", default=EMAIL_OWNER),
    )
]
